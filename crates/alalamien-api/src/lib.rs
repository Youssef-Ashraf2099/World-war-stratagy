...
fn create_router(api_state: ApiState) -> Router {
    ...
    Router::new()
        ...
        .route("/world/clock", get(handlers::get_clock))
        ...
        .route("/nations/:id/alliances", get(handlers::get_nation_alliances))
        .route("/nations/:id/interventions", get(handlers::get_nation_interventions))
        .route("/provinces", get(handlers::get_provinces))
        .route("/provinces/:id", get(handlers::get_province_by_id))
        .route("/alliances", get(handlers::get_alliances))
        .route("/diplomacy/:nation_a/:nation_b", get(handlers::get_diplomacy))
        .route("/interventions", get(handlers::get_interventions))
        .route("/interventions/protectorates", get(handlers::get_protectorates))
        .route("/interventions/refugee-crises", get(handlers::get_refugee_crises))
